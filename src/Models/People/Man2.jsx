...
export function Man2(props) {
  ...
  const group = useRef()
  const { nodes, materials, animations } = useGLTF("./assets/models/people/man2.glb")
  const { actions } = useAnimations(animations, group)

  useEffect(() => {
    actions['HumanArmature|Man_Clapping'].play()
  }, [actions])
...
useGLTF.preload("./assets/models/people/man2.glb");